...
| Response time | measured_latency | 0.742 | mean 3.96 s, sd 1.27 s, n = 15 | 1.000 | mean 2.94 s, sd 0.95 s, n = 15 |
| Cost efficiency | literature | 0.667 | 2/3 sub-criteria | 0.333 | 1/3 sub-criteria |
...
|---|---|---|---|
| Answer correctness | 0.3067 | 0.2658 | 0.2249 |
| Transparency | 0.2800 | 0.2800 | 0.0000 |
| Recency | 0.2000 | 0.1500 | 0.0500 |
| Response time | 0.1067 | 0.0792 | 0.1067 |
| Cost efficiency | 0.1067 | 0.0711 | 0.0356 |
| **Total utility** | 1.0000 | **0.8461** | **0.4171** |

RAG reaches the higher utility (0.8461 versus 0.4171 for Fine-tuning); the gap is 0.4290.
...
|---|---|---|---|---|
| Answer correctness | 0.8370 | 0.2772 | 0.5597 | RAG |
| Transparency | 0.7862 | 0.5793 | 0.2069 | RAG |
| Recency | 0.8701 | 0.4589 | 0.4112 | RAG |
| Response time | 0.8585 | 0.3475 | 0.5109 | RAG |
| Cost efficiency | 0.8675 | 0.4271 | 0.4404 | RAG |

### Random weight perturbation

10000 weight vectors drawn from Dirichlet(concentration 50.0 x expert weights), seed 0, exact arithmetic. Win share: RAG 100.0 %, Fine-tuning 0.0 %. Utility advantage of RAG: mean 0.4289, 5th to 95th percentile 0.3321 to 0.5250, minimum 0.2022.
...
| Response time | 0.1067 | 0.6648 | increase |
...
---
Generated by rag-ft-eval 0.2.0 from `config.yaml` (15 test questions, 5 experts).
